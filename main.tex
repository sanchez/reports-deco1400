...
\newacronym{uq}{UQ}{University of Queensland}
\newacronym{uqms}{UQMS}{\gls{uq} Medical Society}
...
\newglossaryentry{heroku}{
	name={Heroku},
	description={Platform as a Service for hosting of web applications}
}
\newglossaryentry{bootstrap}{
	name={Bootstrap},
	description={\gls{html}/\gls{css} framework for rapidly making mobile and desktop friendly websites}
}
\newglossaryentry{paypal}{
	name={PayPal},
	description={Payment service for handling of bank card details online, a largely trusted site with strong integrity claims}
}
