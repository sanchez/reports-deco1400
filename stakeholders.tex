...
\persona{Jane}{21}{Female}{\begin{itemize}
	...
	\item Wants to gain more confidence with computer science
	\item Would like to see how this can be applied directly in industry
\end{itemize}}{\begin{itemize}
	\item She gives up incredibly easily
	\item Can be overwhelmed quite easily
	\item Can only consume content in small, easy to process blocks
\end{itemize}}

\persona{David}{23}{Male}{\begin{itemize}
	\item Wants to move into a more software development role in his company
	\item Wants to see immediate improvements with himself and his work
	\item Has extensive knowledge already with Information Technology Support roles, but wants to extend on that knowledge
\end{itemize}}{\begin{itemize}
	\item Easily distracted and ends up losing track of current task
	\item Very industry oriented
	\item Time is money, so give me everything as fast as possible mentality
\end{itemize}}
...
\persona{John}{17}{Male}{\begin{itemize}
	...
	\item Would like to learn something he can use across all of this assignments
	\item Needs to be able to recover from his night before breaking changes
\end{itemize}}{\begin{itemize}
	\item Has mentality of ``Why learn this if my old thing can do a similar job''
	\item Not really a software focussed person (knows some basic Python code)
	\item Wants the answer now, doesn't want to take the journey to the answer
\end{itemize}}
...
\persona{Bob}{19}{Male}{\begin{itemize}
	...
	\item Doesn't want to fall behind the rest of the team and get marked down
	\item Just wants a place he can copy paste the commands and use them
\end{itemize}}{\begin{itemize}
	\item He doesn't want to learn, he is just being pressured by the rest of his team
	\item Just wants to be able to copy paste the commands and have them work
	\item Being pressured by the team has left him already frustrated by the use of Git
\end{itemize}}
